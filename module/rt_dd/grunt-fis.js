module.exports = function(grunt, webappRoot, entryFiles) {
	...
	return function(debug){
	    ...
	    if (debug) {
	        ...
	        var logpath = process.cwd() + '/rt_dd_fis.log'
	    ...
	    fis.release(options, function(ret){
	        ...
	        deploy({
	            ...
	            if (debug) {
	                ...
	                ret.pkg = temp
	                grunt.file.write('rt_dd_map.json', JSON.stringify(ret, null, "\t"))
	            }
	            done();
	        }, [{
                pattern: '/static_dd/rt/iform_app/index.html',
                replaces: [
                    {
            ...
            {
                pattern: '{static_dd/rt/iform_app/index.js,pkg/**.js}',
